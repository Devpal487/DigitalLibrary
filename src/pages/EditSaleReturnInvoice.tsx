  ...
  const EditSaleReturnInvoice = () => {
    ...
    const formik = useFormik({
      initialValues: {
        ...
        sR_InvoiceDate: dayjs(location.state.sR_InvoiceDate).format("YYYY-MM-DD") || '',
      ...
      validationSchema: Yup.object().shape({
        ...
        sR_InvoiceDate: Yup.date().required(t("Invoice Date required")),
...
const calculateNetAmount = (amount: number, tax: number, discount: number) => {
              ...
              <Grid item xs={12} container spacing={2}>
                ...
                <Grid item lg={4} xs={12}>
                  <TextField
                    ...
                    helperText={
                      formik.touched.sR_InvoiceDate && typeof formik.errors.sR_InvoiceDate === "string" 
  ...
  export default EditSaleReturnInvoice;
