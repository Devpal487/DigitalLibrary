...
const ClassTimeTable = (props: Props) => {
  ...
  const accept = () => {
    ...
    api.post(`api/Academic/DeleteTimetable`, collectData).then((response) => {
      if (response.data.isSuccess) {
        toast.success(response.data.mesg);
      } else {
        toast.error(response.data.mesg);
  ...
  const fetchZonesData = async () => {
    try {
      ...
      const response = await api.post(`api/Academic/GetTimeTable`, collectData);
      ...
      if (data.length > 0) {
        const columns: GridColDef[] = [
          ...
          {
            field: "dayNo",
            headerName: t("text.DayNo"),
            flex: 1,
            headerClassName: "MuiDataGrid-colCell",
          },
          {
            field: "day",
            headerName: t("text.Day"),
            flex: 1,
            headerClassName: "MuiDataGrid-colCell",
          },
          ...
          {
            field: "subject_name",
            headerName: t("text.ClassSubject"),
            flex: 1,
            headerClassName: "MuiDataGrid-colCell",
          },
          {
              ...
              <Grid xs={12} lg={6} item>
                <Autocomplete
                  ...
                  onChange={(event, newValue: any) => {
                    ...
                    formik.setFieldTouched("program_name", true);
                    formik.setFieldTouched("program_name", false);
                  }}
                  renderInput={(params) => (
                    <TextField
                      {...params}
