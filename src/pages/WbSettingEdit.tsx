...
const WbSettingEdit = (props: Props) => {
  ...
  useEffect(() => {
    ...
    formik.setFieldValue(
      "headerCategoryActive",
      location.state.headerCategoryActive
    );
    console.log(
      "location.state.headerCategoryActive",
      location.state.headerCategoryActive
    );
    formik.setFieldValue("Slider", location.state.Slider);
    formik.setFieldValue(
      "websideLogo",
      filePreview + location.state.websideLogo
    );
  }, []);
  ...
  const formik = useFormik({
    initialValues: {
      settingId: location.state.id,
      name: location.state.name,
      headerCategoryActive: location.state.headerCategoryActive,
      slider: location.state.slider,
      noOfCard: location.state.noOfCard,
      noOfRow: location.state.noOfRow,

      websideLogo: filePreview + location.state.websideLogo,
    },
            ...
            <Grid item xs={12} container spacing={2}>
              ...
              <Grid item lg={5} xs={12}>
                <FormControlLabel
                  control={
                    <Checkbox
                      value={formik.values.headerCategoryActive}
                      checked={formik.values.headerCategoryActive}
                      onChange={handleHeadrCat}
                    />
                  }
