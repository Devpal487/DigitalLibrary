...
const ThemeSettingAdd = (props: Props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const response = await api.post(
        `api/ThemeMaster/AddUpdateThemeMaster`,
        values
      );
              ...
              <Grid container spacing={1} item>
                ...
                >
                  <TextField
                    ...
                    label={<CustomLabel text={t("text.BackgraoundImage")} />}
                    size="small"
                    fullWidth
                    style={{ backgroundColor: "white" }}
                    onChange={(e) =>
                      otherDocChangeHandler(e, "backgroundImage")
                    }
...
export default ThemeSettingAdd;
