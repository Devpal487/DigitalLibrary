...
const LibraryParameterManagement = (props: Props) => {
  ...
  const getusertypeData = async () => {
    ...
    const response = await api.post(
      `api/UserPermission/GetUserType`,
      collectData
    );
    const arr = response?.data?.data?.map((item: any) => ({
  ...
  const getImageData = async () => {
    ...
    console.log("Image base64", response.data.data.libImages);
    if (response?.data?.data?.libImages?.length > 0) {
      let resp = response.data.data.libImages;
  ...
  const modalOpenHandle1 = (event: any) => {
    setOpen(true);
    if (event === "libImages[0]?.imageData") {
      setImg(formik.values.libImages[0]?.imageData);
    }
  };
  ...
  const otherDocChangeHandler = async (event: any, params: string) => {
    ...
    if (event.target.files && event.target.files[0]) {
        ...
        formik.setFieldValue('libImages[0]?.purpose', fileName);
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <Grid item xs={12} container spacing={2}>
                  ...
                  <Autocomplete
                    ...
                    onChange={(event, newValue: any) => {
                      ...
                      if (newValue) {
                        ...
                        formik.setFieldValue(
                          "librarysetupinformation.shortname",
                        ...
                        formik.setFieldValue(
                          "librarysetupinformation.city",
                          res?.details?.city
                        );
                        formik.setFieldValue(
                          "librarysetupinformation.state",
                          res?.details?.state
                        );
                        formik.setFieldValue(
                          "librarysetupinformation.phoneno",
                          res?.details?.phoneno
                        );
                        formik.setFieldValue(
                          "librarysetupinformation.email",
                          res?.details?.email
                        );
                        formik.setFieldValue(
                          "librarysetupinformation.webSite",
                          res?.details?.webSite
                        );
                        formik.setFieldValue(
                          "librarysetupinformation.defUserTypeId",
                          res?.details?.defUserTypeId
                        );
                        formik.setFieldValue(
                        ...
                        formik.setFieldValue(
                          "librarysetupinformation.pincode",
                          parseInt(res?.details?.pincode)
                        );
                      }
                    }}
                    renderInput={(params) => (
              ...
              <Grid item lg={4} xs={12}>
                <TranslateTextField
                  label={
                    createNewLibraryCond === 0
                      ? t("text.nameOfTheOrginsation")
                      : t("text.enterNameOfTheOrginsation")
                  }
              ...
              <Grid item lg={4} xs={12}>
                <TranslateTextField
                  label={
                    createNewLibraryCond === 0
                      ? t("text.nameOfTheLibrary")
                      : t("text.enterNameOfTheLibrary")
                  }
              ...
              <Grid item lg={4} xs={12}>
                <TranslateTextField
                  label={
                    createNewLibraryCond === 0 ? t("text.city") : t("text.city")
                  }
                ...
                <Autocomplete
                  ...
                  value={
                    userTypeNameData.find(
                      (opt: any) =>
                        opt.value ===
                        formik.values.librarysetupinformation.defUserTypeId
                    ) || null
                  }
                  onChange={(event, newValue: any) => {
                    formik.setFieldValue(
                ...
                <Autocomplete
                  ...
                  value={
                    currencyData.find(
                      (opt: any) =>
                        opt.value ===
                        parseInt(formik.values.librarysetupinformation.currency)
                    ) || null
                  }
                  onChange={(event, newValue: any) => {
                    formik.setFieldValue(
              ...
              {createNewLibraryCond ===1 && (
                <Grid item lg={4} xs={12}>
                  <TextField
                    ...
                    name="newLibUser.loginName"
                    label={
                      <CustomLabel
                        text={t("text.LoginForNewLibrary")}
                        required={false}
                      />
                    }
                    value={formik.values.newLibUser.loginName}
                    placeholder={t("text.LoginForNewLibrary")}
                    size="small"
                    type="text"
                    fullWidth
              ...
              {createNewLibraryCond ===1 && (
                <Grid item lg={4} xs={12}>
                  <TextField
                    ...
                    name="newLibUser.passw1"
                    label={
                      <CustomLabel
                        text={t("text.Password")}
                        required={false}
                      />
                    }
                    value={formik.values.newLibUser.passw1}
              ...
              {createNewLibraryCond ===1 && (
                <Grid item lg={4} xs={12}>
                  <TextField
                    ...
                    name="newLibUser.passw2"
                    label={
                      <CustomLabel
                        text={t("text.RepeatPassword")}
                        required={false}
                      />
                    }
                    value={formik.values.newLibUser.passw2}
              ...
              <Grid container spacing={1} item>
                ...
                >
                  <TextField
                    ...
                    style={{ backgroundColor: "white" }}
                    onChange={(e) =>
                      otherDocChangeHandler(e, "libImages[0]?.imageData")
                    }
                  />
                </Grid>
                ...
                <Grid xs={12} md={4} sm={4} item>
                  ...
                  >
                    {formik.values.libImages[0]?.imageData == "" ? (
                      <img
                        src={nopdf}
                        style={{
                          width: 150,
                    ...
                    <Typography
                      onClick={() =>
                        modalOpenHandle1("libImages[0]?.imageData")
                      }
                      style={{
