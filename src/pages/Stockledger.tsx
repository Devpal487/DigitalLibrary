...
export default function Stockledger() {
  ...
  const routeChangeEdit = (row: any) => {
    ...
    formik.setFieldValue(
      "voucherDate",
      dayjs(row.voucherDate).format("YYYY-MM-DD")
    );
    formik.setFieldValue(
      "expiryDate",
  ...
  const accept = () => {
    api
      .post(
        `api/StockLedger/DeleteStockLedger`,
        {},
        { headers: { EntryNo: delete_id } }
      )
      .then((response) => {
        if (response.data.status === 1) {
          toast.success(response.data.message);
  ...
  const fetchStockData = async () => {
    try {
      const response = await api.post(
        `api/StockLedger/GetStockLedger`,
        {},
        { headers: { EntryNo: -1 } }
      );
      const data = response.data.data;
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      const response = await api.post(
        "api/StockLedger/AddUpdateStockLedger",
        values
      );
      if (response.data.status === 1) {
        formik.resetForm();
  ...
  useEffect(() => {
    ...
    if (selectedOption) {
      ...
      const cgstResult =
        (Number(formik.values.rate) *
          Number(formik.values.inQty) *
          (selectedOption.pcent / 2)) /
        100;
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <Grid container item xs={12} spacing={2}>
              ...
              <Grid item xs={12} sm={4} lg={4}>
                <TextField
                  label={
                    <CustomLabel text={t("text.batchNo")} required={false} />
                  }
                  variant="outlined"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} sm={4} lg={4}>
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField
                      {...params}
                      label={<CustomLabel text={t("text.enteritem")} />}
                    />
                  )}
                />
              </Grid>
              ...
              <Grid item xs={12} sm={4} lg={4}>
                <TextField
                  label={
                    <CustomLabel text={t("text.enterrate")} required={false} />
                  }
                  variant="outlined"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} sm={4} lg={4}>
                <TextField
                  label={
                    <CustomLabel text={t("text.enterinQty")} required={false} />
                  }
                  variant="outlined"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} sm={4} lg={4}>
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField
                      {...params}
                      label={<CustomLabel text={t("text.entergstRate")} />}
                    />
                  )}
                />
              </Grid>
              ...
              <Grid item xs={12} sm={4} lg={4}>
                <TextField
                  label={
                    <CustomLabel text={t("text.entercgst")} required={false} />
                  }
                  variant="outlined"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} sm={4} lg={4}>
                <TextField
                  label={
                    <CustomLabel text={t("text.entersgst")} required={false} />
                  }
                  variant="outlined"
                  fullWidth
                  size="small"
              ...
              <Grid item xs={12} sm={4} lg={4}>
                <TextField
                  label={
                    <CustomLabel text={t("text.enterigst")} required={false} />
                  }
                  variant="outlined"
                  fullWidth
                  size="small"
