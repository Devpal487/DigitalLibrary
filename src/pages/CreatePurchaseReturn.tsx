...
const CreatePurchaseReturn = () => {
  ...
  const getPurchaseInvoice = async () => {
    ...
    setPurchaseInvoiceOption([
      { value: "-1", label: t("text.PurchaseInvoiceOption") },
      ...arr,
    ]);
  };
            ...
            <Grid item xs={12} container spacing={2}>
              ...
              <Grid item xs={12} sm={4} lg={4}>
                <TextField
                  ...
                  onChange={formik.handleChange}
                  error={
                    formik.touched.pR_InvoiceNo &&
                    Boolean(formik.errors.pR_InvoiceNo)
                  }
                  helperText={
                    formik.touched.pR_InvoiceNo && formik.errors.pR_InvoiceNo
                  }
                />
              </Grid>
